...
export default function ArticleTestPage() {
  ...
  // Yulduzlar ketma-ket "yonadi": 0 → 1 → ... → finalStars.
  // 500ms boshlang'ich pauza, keyin har 400ms'da bittasi qo'shiladi.
  // Retry paytida finalStars 0'ga tushadi va useEffect qayta trigger
  // bo'ladi -- animatsiya har safar toza boshlanadi.
  ...
  // Result animatsiya. `phase === 'result'` bo'lganda 500ms kutib
  // yulduzlarni ketma-ket yoqamiz (har 400ms), keyin 5⭐ bo'lsa
  // qo'shimcha ~300ms delay bilan confetti. showResultTail score +
  // best-so-far + tugmalar fade-in'ini boshqaradi -- yulduzlar
  // tugagach ochiladi.
  useEffect(() => {
    ...
    timers.push(setTimeout(() => {
      ...
      if (finalStars === 5) {
        timers.push(setTimeout(() => fireCelebrationConfetti(), finalStars * 400 + 300))
      }
    }, 500))
    ...
    return (
      <div className="p-6 md:p-10 max-w-xl mx-auto">
        ...
        >
          ...
          {/* Score, natija xabari, best-so-far va tugmalar -- yulduzlar
              tugagach fade-in bilan chiqadi (showResultTail). Tail
              chiqmagan paytda joyni saqlaydi (opacity 0 + visibility). */}
          <div style={{
