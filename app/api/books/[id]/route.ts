...
export async function PATCH(
  ...
  const allowed = ['title', 'author', 'heyzine_url', 'pdf_url', 'source_type', 'cover_image_url', 'recommendation', 'recommendation_uz', 'recommendation_en', 'category', 'is_premium', 'is_published']
