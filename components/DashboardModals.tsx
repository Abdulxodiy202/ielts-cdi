...
export function DashboardModals({ isPremium }: { isPremium: boolean }) {
  ...
  // Study Plan hozircha "Ishlab chiqilmoqda" holatida — onboarding
  // modal butunlay disable. Tayyor bo'lganda pastdagi JSX'ni qayta
  // yoqish + yuqoridagi phase mantig'ini tiklash yetarli.
