  ...
  const CATEGORIES = [
    {
      ...
      emoji: '🎮',
      titleKey: 'vocabulary.games',
      descKey:  'vocabulary.gamesDesc',
      count: t('vocabulary.gamesLevels'),
      color: '#8b5cf6',
    ...
    },
    {
      ...
      count:    wcCount !== null ? t('vocabulary.wordCount', { count: wcCount }) : '...',
      color: '#ec4899',
    ...
    },
    {
      ...
      count:    lwCount !== null ? t('vocabulary.wordCount', { count: lwCount }) : '...',
      color: '#14b8a6',
