  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold mb-1" style={{ color: 'var(--text-primary)' }}>✍️ Writing Collocations</h1>
        <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
          Essential collocations and phrases for IELTS Writing Task 1 and Task 2
        </p>
      </div>
      <div className="py-20 text-center rounded-2xl" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
        ...
        <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
          Writing collocations and academic phrase bank coming soon.
        </p>
      </div>
    </div>
  )
