...
export default function VideoTestPage() {
  ...
  // Fire confetti once when a 5-star result first lands. rAF gives the
  // result ref one frame to attach so the anchor-based origin is
  // measurable, not (0,0). firedRef prevents re-fire on rerenders.
  useEffect(() => {
    if (phase === 'result' && finalStars === 5 && !firedRef.current) {
